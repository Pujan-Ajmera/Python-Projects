...
# this code works good and great like stops if the same reel plays for 2 times and if its not a reel then it waits for 6 seconds and then stops playing (accidentally happened)
